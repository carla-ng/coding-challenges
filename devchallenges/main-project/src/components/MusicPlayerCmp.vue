<template>
    <section class="mp-cmp">
        <div class="mp-cmp_inner-container">
            <figure class="mp-cmp_img">
                <img src="/src/assets/music-player/img/cover-1.png" alt="Lost in the City Lights cover">
            </figure>

            <h1 class="mp-cmp_title">Lost in the City Lights</h1>
            <span class="mp-cmp_artist">Cosmo Sheldrake</span>
