<template>
    <section class="al-cmp">
        <header>
            <div class="al-cmp_go-back">
                <svg width="29px" height="29px" viewBox="0 0 72 72" fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 72 72" xml:space="preserve">
                    <g>
            ...
            <h1 class="al-cmp_title">Alarm</h1>
            <div class="al-cmp_settings">
        ...
        <div class="al-cmp_alarms-container">
            <button class="al-cmp_add-new-alarm">
                <span>+</span>
            </button>
...
.al-cmp {
    ...
    border-radius: 10px;
    box-shadow: 3px 5px 5px darken($al-accent-color-01, 5%);
    margin: 1rem;
    overflow: hidden;
    position: relative;
    ...
    header {
        ...
        .al-cmp_settings {
            ...
            svg {
                circle, path { stroke: $al-accent-color-01; }
            }
        }
    }

    .al-cmp_time-container {
        padding: 1rem 2rem;
        position: relative;
        text-align: center;
        z-index: 1;
    ...
    .al-cmp_alarms-container {
        ...
        button.al-cmp_add-new-alarm {
            background-color: $al-accent-color-02;
            border: none;
            border-radius: 50%;
            box-shadow: 0px 1px 5px $al-accent-color-01;
            cursor: pointer;
            height: 45px;
            position: relative;
            width: 45px;
